    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leaves_left', models.IntegerField(blank=True, default=12, null=True)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ('email', models.EmailField(max_length=80, unique=True)),
                ('employment_type', models.CharField(choices=[('part-time', 'Part-time'), ('full-time', 'Full-time')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('sick', 'Sick'), ('personal', 'Personal')], max_length=20)),
